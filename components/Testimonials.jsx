...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      date: "11 Dec 2019",
      message:
        "I applied for a personal loan on Cheapkart Finance. Manish Sharma was knowledgeable and efficient — great follow-ups and excellent communication. Highly recommended!",
    },
  ];
  return (
    <section className="bg-gray-50 py-12" id="testimonials">
      <div className="max-w-[1600px] mx-auto px-4 relative">
        <h3 className="text-2xl sm:text-3xl font-bold text-center mb-16 md:mb-8">
          Cheapkart Finance&apos;s Success Stories
        </h3>
