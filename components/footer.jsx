  ...
  return (
    <div>
          ...
          <div className="text-white/75 text-[13px]   grid-cols-2 md:grid-cols-4 gap-5 hidden sm:grid">
            <div className="max-w-[320px]">
              ...
              <div>
                ...
                empowerment across India. the organization is committed to
                supporting economically weaker sections in rural and semi-urban
                areas.
              </div>
            </div>
      ...
      <div className="py-4 text-[12px] px-3 text-gray-500 max-w-[1600px] w-full mx-auto  bg-white">
        © 2025 <span className="font-semibold">Cheapkart Finance</span>. All
        rights reserved
      </div>
      <MessageTab />
    </div>
