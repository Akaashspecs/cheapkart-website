const PrivacyPolicy = ({ setPrivacyPageOpen }) => {
  const privacyPolicyText = [
    ...
    },
    {
      ...
      desc2: "To exercise your rights, contact us at: contact@cheapkart.in",
    },
    {
      id: 6,
    ...
    <div className="w-full">
      <div className="  md:p-14 p-5  shadow-lg rounded-2xl  ">
        ...
        <div className="text-[14px] text-gray-700 mt-4">
          At Cheapkart Finance Money, we deeply value your trust and are
          committed to protecting your personal and financial information. This
        ...
        <div className="bg-blue-500/20 text-blue-500 p-3 text-[14px] rounded-xl mt-3 text-center">
          Your privacy is our commitment. At Cheapkart Finance , we ensure your
