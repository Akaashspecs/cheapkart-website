const TermsAndConditions = ({ setPrivacyPageOpen }) => {
  const privacyPolicyText = [
    ...
    },
    {
      ...
      desc: "Cheapkart Finance offers the following services through backed models:",
      desc2:
    ...
    },
    {
      ...
      desc: "By applying for any service, you authorize Cheapkart Finance  to:",
      list: [
    ...
    },
    {
      ...
      desc: "Cheapkart Finance shall not be liable for any indirect, incidental, or consequential damages arising from:",
      list: [
    ...
    },
    {
      ...
      desc: "All logos, content, branding, and technology used by Cheapkart Finance are proprietary. Unauthorized use or reproduction is strictly prohibited.",
    },
    {
      id: 10,
    ...
    },
    {
      ...
      desc: "Cheapkart Finance may update these Terms & Conditions at any time without prior notice. The updated version will be posted on our official platform. Continued use of services implies acceptance of changes.",
    },
    {
      id: 12,
      heading: "Limitation of Liability",
      ...
      list: [
        ...
        "Address: A4, Govind Vihar, Gomti Nagar, Lucknow, 226028",
      ],
    },
  ];
    ...
    <div className="flex justify-center items-center ">
      <div className=" md:p-14 p-5   shadow-lg rounded-2xl  ">
        ...
        <div className="text-[14px] text-gray-700 mt-4">
          Welcome to Cheapkart Finance, By accessing or using our services, you
        ...
        <div className="bg-blue-500/20 text-blue-500 p-3 text-[14px] rounded-xl mt-3 text-center">
          By using Cheapkart Finance, you agree to these Terms & Conditions.
          Your trust and cooperation help us build a stronger, more financially
          inclusive India.
        </div>
      </div>
    </div>
